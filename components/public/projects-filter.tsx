...
import { Search, SlidersHorizontal, X, MapPin, Grid3X3, Map, ArrowUpRight } from "lucide-react";
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div className="min-w-0 flex-1">
                                            <p className="truncate text-sm font-bold text-white transition-colors group-hover:text-brand-orange">
                                                {project.nombre}
                                            </p>
                                    ...
                                    {canEdit && (
                                        <Link
                                            href={`/dashboard/proyectos/${project.slug || project.id}/editar`}
                                            className="mt-3 inline-flex items-center gap-2 self-start rounded-full bg-brand-orange px-3.5 py-2 text-[11px] font-bold text-white shadow-lg shadow-brand-orange/20 transition-all hover:bg-brand-orangeDark hover:scale-[1.02] active:scale-95"
                                        >
                                            Editar proyecto
