            ...
            <Table>
                <TableHeader className="bg-slate-50 dark:bg-white/5">
                    <TableRow className="border-white/10 hover:bg-transparent">
                        <TableHead className="text-xs font-black uppercase text-slate-400">Proyecto</TableHead>
                        <TableHead className="text-xs font-black uppercase text-slate-400">Organización</TableHead>
                        <TableHead className="text-xs font-black uppercase text-slate-400">Estado</TableHead>
                        <TableHead className="text-xs font-black uppercase text-slate-400">Canal / CRM</TableHead>
                        <TableHead className="text-right text-xs font-black uppercase text-slate-400">Acciones</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
                        ...
                        <TableRow key={project.id} className="border-slate-100 dark:border-white/5 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
                            <TableCell>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500 uppercase tracking-tighter">ID: {project.id}</p>
                                    </div>
                                </div>
                            </TableCell>
                            <TableCell>
                                <div className="flex flex-col">
                                    ...
                                    <Badge variant="outline" className="w-fit text-xs py-0 px-1 mt-1 border-emerald-500/30 text-emerald-500">
                            ...
                            <TableCell>
                                <div className="flex items-center gap-2">
                                    <Badge variant="secondary" className="text-xs">{project._count.leads} Leads</Badge>
                                    ...
                                    <SheetContent className="dark:bg-[#111116] border-white/10">
                                        ...
                                        <div className="mt-8 space-y-6">
                                            <div className="p-4 bg-brand-500/5 rounded-2xl border border-brand-500/10 mb-6">
                                                <p className="text-xs font-black text-brand-500 uppercase mb-1">Plan de la Org</p>
