    ...
    return (
        <div className="space-y-6 max-w-4xl mx-auto">
            <div className="flex justify-end items-center mb-2">
                <Button onClick={onSubmit} disabled={isLoading} className="bg-brand-500 hover:bg-brand-600 text-white min-w-[120px] rounded-xl shadow-lg shadow-brand-500/20 font-black uppercase text-sm tracking-tight">
            ...
            <Tabs defaultValue="notifications" className="w-full">
                <TabsList className="grid w-full grid-cols-3 bg-slate-100 dark:bg-white/[0.02] border border-slate-200 dark:border-white/[0.06] p-1 h-auto rounded-xl">
                    <TabsTrigger value="notifications" className="py-2.5 rounded-lg text-sm font-black uppercase tracking-widest data-[state=active]:bg-white dark:data-[state=active]:bg-white/[0.04] data-[state=active]:text-slate-900 dark:data-[state=active]:text-white data-[state=active]:shadow-sm transition-colors">
                        <Bell className="w-4 h-4 mr-2" /> Notificaciones
                    </TabsTrigger>
                    <TabsTrigger value="general" className="py-2.5 rounded-lg text-sm font-black uppercase tracking-widest data-[state=active]:bg-white dark:data-[state=active]:bg-white/[0.04] data-[state=active]:text-slate-900 dark:data-[state=active]:text-white data-[state=active]:shadow-sm transition-colors">
                        <Globe className="w-4 h-4 mr-2" /> General
                    </TabsTrigger>
                    <TabsTrigger value="privacy" className="py-2.5 rounded-lg text-sm font-black uppercase tracking-widest data-[state=active]:bg-white dark:data-[state=active]:bg-white/[0.04] data-[state=active]:text-slate-900 dark:data-[state=active]:text-white data-[state=active]:shadow-sm transition-colors">
                        ...
                        <CardContent className="space-y-6">
                            <div className="flex items-center justify-between space-x-2 p-3 hover:bg-slate-50 dark:hover:bg-white/[0.01] rounded-xl border border-transparent hover:border-slate-100 dark:hover:border-white/[0.04] transition-all">
                                <Label htmlFor="emailLeads" className="flex flex-col space-y-1.5 cursor-pointer">
                                    ...
                                    <span className="font-bold text-xs uppercase tracking-widest text-slate-500 dark:text-white/30">Recibir un email cuando se asigne un nuevo lead.</span>
                                </Label>
                            ...
                            <div className="flex items-center justify-between space-x-2 p-3 hover:bg-slate-50 dark:hover:bg-white/[0.01] rounded-xl border border-transparent hover:border-slate-100 dark:hover:border-white/[0.04] transition-all">
                                <Label htmlFor="emailReservas" className="flex flex-col space-y-1.5 cursor-pointer">
                                    ...
                                    <span className="font-bold text-xs uppercase tracking-widest text-slate-500 dark:text-white/30">Recibir un email cuando se cree una reserva.</span>
                                </Label>
                            ...
                            <div className="flex items-center justify-between space-x-2 p-3 hover:bg-slate-50 dark:hover:bg-white/[0.01] rounded-xl border border-transparent hover:border-slate-100 dark:hover:border-white/[0.04] transition-all">
                                <Label htmlFor="pushSystem" className="flex flex-col space-y-1.5 cursor-pointer">
                                    ...
                                    <span className="font-bold text-xs uppercase tracking-widest text-slate-500 dark:text-white/30">Mantenimiento o actualizaciones del sistema.</span>
                                </Label>
                    ...
                    <Card className="bg-white dark:bg-[#0A0A0C] border-slate-200 dark:border-white/[0.06] text-slate-900 dark:text-white rounded-2xl shadow-none">
                        ...
                        <CardContent className="space-y-8">
                            <div className="space-y-4 px-3">
                                <Label className="text-sm font-black uppercase tracking-widest text-slate-500 dark:text-white/40">Tema visual</Label>
                            ...
                            <div className="space-y-4 px-3">
                                <Label className="text-sm font-black uppercase tracking-widest text-slate-500 dark:text-white/40">Idioma de la plataforma</Label>
                                <Select value={settings.appearance.language} onValueChange={(val) => handleSelect("appearance", "language", val)}>
                                    ...
                                    <SelectContent className="bg-white dark:bg-[#0A0A0C] border-slate-200 dark:border-white/[0.06] rounded-xl shadow-lg">
                                        <SelectItem value="es" className="text-sm font-bold uppercase tracking-widest cursor-pointer focus:bg-slate-50 dark:focus:bg-white/[0.04]">Español</SelectItem>
                                        <SelectItem value="en" className="text-sm font-bold uppercase tracking-widest cursor-pointer focus:bg-slate-50 dark:focus:bg-white/[0.04]">English</SelectItem>
                                    </SelectContent>
                                </Select>
                            </div>
                        </CardContent>
                        ...
                        <CardContent className="space-y-6">
                            <div className="flex items-center justify-between space-x-2 p-3 hover:bg-slate-50 dark:hover:bg-white/[0.01] rounded-xl border border-transparent hover:border-slate-100 dark:hover:border-white/[0.04] transition-all">
                                <Label htmlFor="showProfile" className="flex flex-col space-y-1.5 cursor-pointer">
                                    ...
                                    <span className="font-bold text-xs uppercase tracking-widest text-slate-500 dark:text-white/30">Permitir que otros vean mi información básica.</span>
                                </Label>
                            ...
                            <div className="pt-8 mt-2 border-t border-slate-200 dark:border-white/[0.06] px-3">
                                <Label className="text-sm font-black uppercase tracking-widest text-rose-500 mb-2 block">Zona de Peligro</Label>
                                <p className="font-bold text-xs uppercase tracking-widest text-slate-500 dark:text-white/30 mb-6">Acciones irreversibles sobre tu cuenta en SevenToop.</p>
                                <Button variant="destructive" size="sm" className="rounded-xl font-black uppercase text-xs tracking-tight hover:bg-rose-600 transition-colors">
