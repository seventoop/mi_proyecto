...
export default function MasterplanSidePanel({ unit, modo, canEdit = false, onClose }: SidePanelProps) {
    ...
    return (
        <>
            <motion.div
                ...
                className="absolute top-0 right-0 bottom-0 w-[340px] bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-l border-slate-200 dark:border-slate-700 z-[5000] flex flex-col shadow-2xl"
            >
                {/* Header */}
