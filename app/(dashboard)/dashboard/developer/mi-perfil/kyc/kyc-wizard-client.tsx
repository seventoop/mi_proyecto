            ...
            <div className="flex items-start justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-sm font-medium mt-1">
                        Completa los 4 pasos para verificar tu identidad y perfil profesional.
                    </p>
                </div>
                <div className={cn("px-3 py-1.5 rounded-xl border flex items-center gap-1.5 text-xs font-black uppercase", badge.color)}>
                ...
                {STEPS.map((s, i) => {
                    ...
                    return (
                        <div key={s.id} className="flex items-center flex-1">
                            ...
                            {i < STEPS.length - 1 && (
                                <div className={cn("h-px flex-1 mx-1 transition-colors", isDone ? "bg-emerald-500" : "bg-slate-200 dark:bg-white/10")} />
                            )}
                        </div>
                    );
                })}
            ...
            <div className="glass-card p-6 space-y-6">
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="space-y-1">
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 text-sm bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-500 disabled:opacity-50"
                                />
                            </div>
                            <div className="space-y-1">
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            profile.especialidad === e
                                                ...
                                                : "border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-400 hover:border-brand-500/50"
                                        )}
                                    >
                                        {e.replace("_", " ")}
                                    </button>
                        ...
                        <div className="space-y-1">
                            ...
                            <textarea
                                ...
                                className="w-full px-3 py-2 text-sm bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-500 resize-none disabled:opacity-50"
                            />
                        </div>

                        <div className="flex justify-between pt-2">
                            <button onClick={() => setStep(0)} className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-black uppercase text-slate-500 hover:text-slate-700 transition-colors">
                ...
                {step === 2 && (
                    <div className="space-y-5">
                        ...
                        <div className="flex justify-between pt-2">
                            <button onClick={() => setStep(1)} className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-black uppercase text-slate-500 hover:text-slate-700 transition-colors">
                                <ChevronLeft className="w-4 h-4" /> Volver
                            </button>
                            <button
                        ...
                        {!isLocked && (
                            <div className="pt-4 border-t border-white/10">
                                ...
                                <div className="flex justify-between">
                                    <button onClick={() => setStep(2)} className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-black uppercase text-slate-500 hover:text-slate-700 transition-colors">
                                        <ChevronLeft className="w-4 h-4" /> Volver
                                    </button>
                                    <button
