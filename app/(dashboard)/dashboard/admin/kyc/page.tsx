...
function DocLink({ url, label }: { url?: string | null; label: string }) {
    if (!url) return (
        <div className="p-3 rounded-xl bg-white dark:bg-[#0A0A0C] border border-slate-200 dark:border-white/[0.06] flex items-center gap-3 opacity-40">
            ...
            <span className="text-[10px] uppercase font-black tracking-widest text-slate-500">{label} — N/A</span>
        </div>
    );
    return (
        <a
        ...
        >
            ...
            <div>
                ...
                <p className="text-[9px] font-bold uppercase tracking-widest text-slate-500">Clic para abrir</p>
            </div>
        </a>
    );
}
        ...
        <div className="p-6 max-w-[1600px] mx-auto space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mt-8">
                <div className="flex bg-slate-50 dark:bg-[#0A0A0C] border border-slate-200 dark:border-white/[0.06] p-1.5 rounded-xl w-fit">
                    <button
                        ...
                        className={cn(
                            "px-4 py-2 rounded-lg text-[10px] uppercase tracking-widest transition-all flex items-center gap-2",
                            view === 'DEVELOPER'
                ...
                <div className="bg-slate-50 dark:bg-[#0A0A0C] border border-slate-200 dark:border-white/[0.06] px-4 py-2 rounded-xl text-[10px] uppercase tracking-widest font-black text-slate-600 dark:text-slate-400">
            ...
            {loading ? (
                ...
                <div className="text-center py-20 bg-slate-50 dark:bg-[#0A0A0C] rounded-3xl border border-slate-200 dark:border-white/[0.06]">
                    ...
                    <p className="text-[10px] font-bold uppercase tracking-widest text-slate-500 mt-2">Todas las revisiones de {view === 'DEVELOPER' ? 'desarrolladores' : 'inversores'} están al día.</p>
                </div>
            ) : (
                <div className="space-y-4">
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-3">
                                        {profile.tipoDeveloper && (
                                            <span className="hidden sm:inline px-2.5 py-1 rounded-md text-[9px] font-black uppercase tracking-widest bg-violet-500/10 text-violet-600 dark:text-violet-500 border border-transparent">
                                                {TIPO_LABELS[profile.tipoDeveloper] ?? profile.tipoDeveloper}
                                            </span>
                                        )}
                                        <span className="px-2.5 py-1 rounded-md text-[9px] font-black uppercase tracking-widest bg-amber-500/10 text-amber-600 dark:text-amber-500 border border-transparent">
                                            EN REVISIÓN
                                        </span>
                                        <span className="hidden md:block text-[9px] font-bold uppercase tracking-widest text-slate-500">{submittedAt}</span>
                                        {isExpanded
                                    ...
                                    <div className="border-t border-slate-100 dark:border-white/[0.06] bg-slate-50/50 dark:bg-black/20 p-6 space-y-6">
                                        {view === 'DEVELOPER' ? (
                                            ...
                                            <>
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                                    {profile.selfieUrl && (
                                                        <div className="space-y-2">
                                                            <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Selfie</p>
                                                            <img
                                                    ...
                                                    <div className="md:col-span-2 space-y-2">
                                                        ...
                                                        <div className="grid grid-cols-2 gap-3 text-sm">
                                                            {profile.tipoDeveloper && (
                                                                <div>
                                                                    <span className="text-slate-500 font-bold uppercase tracking-widest text-[9px]">Tipo</span>
                                                            ...
                                                            {profile.especialidad && (
                                                                <div>
                                                                    <span className="text-slate-500 font-bold uppercase tracking-widest text-[9px]">Especialidad</span>
                                                            ...
                                                            {profile.yearsExperience != null && (
                                                                <div>
                                                                    <span className="text-slate-500 font-bold uppercase tracking-widest text-[9px]">Años exp.</span>
                                                            ...
                                                            {profile.proyectosRealizados != null && (
                                                                <div>
                                                                    <span className="text-slate-500 font-bold uppercase tracking-widest text-[9px]">Proyectos</span>
                                                        ...
                                                        {profile.descripcionProfesional && (
                                                            <div className="mt-2">
                                                                <span className="text-slate-500 font-bold uppercase tracking-widest text-[9px]">Descripción</span>
                                                                <p className="text-[11px] font-bold text-slate-700 dark:text-slate-400 mt-0.5 leading-relaxed">{profile.descripcionProfesional}</p>
                                                            </div>
                                                        )}
                                                    </div>
                                                </div>
                                                ...
                                                {(profile.razonSocial || profile.cuitEmpresa || profile.ciudad) && (
                                                    <div className="space-y-2 mt-6">
                                                        ...
                                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                                                            {profile.razonSocial && (
                                                                <div>
                                                                    <span className="text-slate-500 font-bold uppercase tracking-widest text-[9px]">Razón Social</span>
                                                            ...
                                                            {profile.nombreComercial && (
                                                                <div>
                                                                    <span className="text-slate-500 font-bold uppercase tracking-widest text-[9px]">Nombre Comercial</span>
                                                                    <p className="font-black text-[12px] uppercase tracking-tighter text-slate-800 dark:text-slate-200">{profile.nombreComercial}</p>
                                                                </div>
                                                            )}
                                                            {profile.cuitEmpresa && (
                                                                <div>
                                                                    <span className="text-slate-500 font-bold uppercase tracking-widest text-[9px]">CUIT</span>
                                                            ...
                                                            {profile.ciudad && (
                                                                <div>
                                                                    <span className="text-slate-500 font-bold uppercase tracking-widest text-[9px]">Ubicación</span>
                                                ...
                                                <div className="space-y-2 mt-6">
                                                    <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Documentación Legal</p>
                                            ...
                                            <>
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                                    ...
                                                    <div className="space-y-4 border-r-0 md:border-r border-slate-100 dark:border-white/[0.06] pr-0 md:pr-6">
                                                        <div className="space-y-2">
                                                            <p className="text-[10px] font-black uppercase tracking-widest text-slate-500">Selfie con documento</p>
                                                            {profile.selfieUrl ? (
                                                                <img
                                                                    src={profile.selfieUrl}
                                                                    alt="Selfie"
                                                    ...
                                                    <div className="md:col-span-2 space-y-6">
                                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                                            <div className="space-y-4">
                                                                <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Perfil Financiero</p>
                                                                <div className="space-y-3">
                                                                    <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0C] border border-slate-200 dark:border-white/[0.06]">
                                                                        <span className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Perfil de Riesgo</span>
                                                                        <p className={cn(
                                                                    ...
                                                                    <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0C] border border-slate-200 dark:border-white/[0.06]">
                                                                        <span className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Ingresos Estimados</span>
                                                                    ...
                                                                    <div className="p-4 rounded-xl bg-white dark:bg-[#0A0A0C] border border-slate-200 dark:border-white/[0.06]">
                                                                        <span className="text-[9px] font-bold text-slate-500 uppercase tracking-widest">Patrimonio Estimado</span>
                                                            ...
                                                            <div className="space-y-4">
                                                                <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Datos de Usuario</p>
                                                                <div className="space-y-4 font-bold text-[11px] uppercase tracking-widest">
                                                        ...
                                                        <div className="p-4 rounded-xl bg-emerald-500/5 dark:bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-500 text-[10px] font-black uppercase tracking-widest flex items-center gap-2">
                                        ...
                                        <div className="flex items-center justify-end gap-3 pt-6 mt-4 border-t border-slate-200 dark:border-white/[0.06]">
                                            <button
                                                ...
                                                disabled={submitting}
                                                className="px-6 py-2.5 rounded-xl border border-rose-500 text-rose-500 hover:bg-rose-500/10 font-bold uppercase tracking-widest text-[10px] transition-colors flex items-center gap-2 disabled:opacity-50"
                                            >
                                            ...
                                            <button
                                                ...
                                                disabled={submitting}
                                                className="px-6 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white font-bold uppercase tracking-widest text-[10px] transition-all flex items-center gap-2 disabled:opacity-50 shadow-lg shadow-emerald-500/20"
                                            >
